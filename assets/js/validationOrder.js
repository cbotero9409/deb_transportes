...
{
    var insured_format = /^[\w\á-ú\Á-Ú\s\ñ#-]+$/;
...
document.orders_form.receive_date.value = today1;
...
{
    var claim_format = /^[\d]+?/;
    if (claim.value.length <= 20 && claim.value !== '')
    {
...
{
    var contact_format = /^[\a-zA-Z\s\ñ\á-ú\Á-Ú]+$/;
...
document.orders_form.municipality.value = "Medellín";
