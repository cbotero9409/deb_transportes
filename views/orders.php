...
<!DOCTYPE html>
<html>
    <?= $layout->head('Ordenes de Servicio'); ?>
    <body>
        <div id='wrapper'>
            ...
            <div id='page-content-wrapper'>
                ...
                <?= $layout->navTitle("Admin", 1, "Ordenes de Servicio");?>
                <!-- Page Content -->
                ...
                <a href="createOrder.php"><button type="button" class="btn new_order btn-primary">+ Crear Orden</button></a>
                ...
                <div class="table-responsive">
                    <table id="table-id" class="table table-striped table-hover table-bordered">
                        <thead>
                            <tr>
                                <th></th>
                                <th scope='col'><span class="table_column_2">Número de reclamación</span></th>
                        ...
                        <tbody id="orders_table"><?=$controller->readOrder();?></tbody>
                    </table>
                </div>
