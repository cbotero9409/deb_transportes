    ...
    <body>
        <div id='wrapper'>
            ...
            <div id='page-content-wrapper'>
                ...
                <?= $layout->navTitle("Admin", 1, "Crear Usuario"); ?>   

                <!-- Page Content -->
                <div class="row">
                    <div class="col-8 col-md-6 col-lg-6  mx-auto mt-5">
                        <form  name='registration' onSubmit="return formValidation()" action="../back_end/userController.php?type=create" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="d-flex">
                                    <label for="user" class="col-sm-4 col-form-label">Nombre:</label>
                                    <input type="text" class="form-control pgtion" placeholder="Nombre" name="name"  id="name" onchange="allLetter(this)" required>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <input type="email" class="form-control pgtion" placeholder="Correo" name="email"  id="e-mail" onchange="ValidateEmail(this)" required>
                                </div>
                            ...
                            <div class="form-group ">
                                <div class="d-flex">
                                    ...
                                    <input type="password" class="form-control pgtion" placeholder="Contraseña" name="password" id="password" onchange="password_validation(this)"  required>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex">
                                    ...
                                    <input type="text" class="form-control pgtion" placeholder="Usuario" name="user" id="user" onchange="user_validation(this)" required>
                                </div>
